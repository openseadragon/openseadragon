...
(function() {
    ...
    QUnit.test('tile-loaded event includes AJAX request object', function(assert) {
        ...
        const tileLoaded = function tileLoaded(evt) {
    ...
    QUnit.test('tile-load-failed event includes AJAX request object', function(assert) {
        ...
        const brokenTileSource = OpenSeadragon.extend({}, customTileSource, {
            getTileUrl: function () {
                return '/test/data/testpattern.blob.invalid';
            }
        });

        const tileLoadFailed = function tileLoadFailed(evt) {
    ...
    QUnit.test('Headers are propagated correctly', function(assert) {
        ...
        const staticHeaderTileSource = OpenSeadragon.extend({}, customTileSource, {
    ...
    QUnit.test('Viewer headers can be updated', function(assert) {
        ...
        const tileLoaded2 = function tileLoaded(evt) {
        ...
        const tileLoaded3 = function tileLoaded(evt) {
        ...
        const tileLoaded4 = function tileLoaded(evt) {
